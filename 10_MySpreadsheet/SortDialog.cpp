...
void SortDialog::onMoreButtonClicked(bool isToggled)
{
...
void SortDialog::init()
{
    ...
    connect(moreButton, &QPushButton::toggled, this, &SortDialog::onMoreButtonClicked);
}

void SortDialog::fillGroupBoxes()
{
    setColumnRange('A', 'Z');
