...
#include <memory>
#include "../../../untitled1/FindDialog.h"
...
QT_MOC_LITERAL(7, 57, 17), // "findButtonOnClick"
QT_MOC_LITERAL(8, 75, 16) // "enableFindButton"

    },
    "FindDialog\0findNext\0\0str\0Qt::CaseSensitivity\0"
    "cs\0findPrev\0findButtonOnClick\0"
    "enableFindButton"
};
...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->findNext((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const Qt::CaseSensitivity(*)>(_a[2]))); break;
        case 1: _t->findPrev((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const Qt::CaseSensitivity(*)>(_a[2]))); break;
        case 2: _t->findButtonOnClick(); break;
        ...
        {
            using _t = void (FindDialog::*)(const QString & , const Qt::CaseSensitivity );
...
// SIGNAL 0
void FindDialog::findNext(const QString & _t1, const Qt::CaseSensitivity _t2)
{
...
// SIGNAL 1
void FindDialog::findPrev(const QString & _t1, const Qt::CaseSensitivity _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
